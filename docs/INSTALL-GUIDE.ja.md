...
> 🌐 [English](INSTALL-GUIDE.md) | [中文](INSTALL-GUIDE.zh.md) | **日本語** | [Deutsch](INSTALL-GUIDE.de.md)

> ⚠️ **プラットフォームテスト状況**：
> - **Windows**：✅ 完全にテスト済みでサポート
> - **Linux**：⚠️ テスト未完了 - 問題が発生する可能性があります
> - **macOS**：⚠️ テスト未完了 - 問題が発生する可能性があります
